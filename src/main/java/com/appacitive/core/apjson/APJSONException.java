...
/**
 * Thrown to indicate a problem with the APJSON API. Such problems include:
 * <ul>
 * <li>Attempts to parse or construct malformed documents
 * <li>Use of null as a name
 * <li>Use of numeric types not available to APJSON, such as {@link
 ...
 * rethrow:
 * <pre>  public APJSONArray toJSONObject() {
 *     try {
 ...
 * }</pre>
 */
public class APJSONException extends Exception {

    public APJSONException(String s) {
        super(s);
    }
}
