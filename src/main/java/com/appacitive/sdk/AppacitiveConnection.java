...
public class AppacitiveConnection extends AppacitiveEntity {
    ...
    public void createInBackground(Callback<AppacitiveConnection> callback)
    {
        ...
        final String url = Urls.ForConnection.createConnectionUrl(this.relationType);
    ...
    {
        final String url = Urls.ForConnection.deleteConnectionUrl(this.relationType, this.getId());
        final Map<String, String> headers = Headers.assemble();
    ...
    {
        final String url = Urls.ForConnection.bulkDeleteConnectionUrl(relationType);
        final Map<String, String> headers = Headers.assemble();
    ...
    {
        final String url = Urls.ForObject.updateObjectUrl(this.relationType, this.getId());
        final Map<String, String> headers = Headers.assemble();
        final Map<String, Object> payload = new HashMap<String, Object>();
    ...
    {
        final String url = Urls.ForConnection.getConnectionUrl(relationType, this.getId());
        final Map<String, String> headers = Headers.assemble();
    ...
    public static void multiGetInBackground(String relationType, long[] connectionIds, String[] fields, Callback<List<AppacitiveConnection>> callback) throws ValidationError
    {
        if(relationType.isEmpty())
